    ...
    <article className="w-[min(88vw,300px)] sm:w-[min(70vw,320px)] shrink-0 snap-center">
      <GlowCard className="rounded-2xl overflow-hidden h-full">
        ...
        <div className="p-4 border-t border-[rgba(0,240,255,0.1)]">
          <h4 className="font-[family-name:var(--font-orbitron)] text-sm sm:text-base text-white">
            {item.title}
          </h4>
          <p className="text-slate-400 text-xs sm:text-sm mt-1">{item.caption}</p>
        </div>
      </GlowCard>
    </article>
  );
      ...
      <div id={id} className="scroll-mt-28">
        <div className="flex items-center gap-3 mb-5 px-1">
          ...
          <div>
            ...
            <h3 className="font-[family-name:var(--font-orbitron)] text-xl sm:text-2xl font-bold text-white">
              {title}
            </h3>
          </div>
        </div>
          ...
          {items.map((item) => (
            <div key={item.src} className="min-w-0">
              <GlowCard className="rounded-2xl overflow-hidden h-full">
                ...
                <div className="p-4 border-t border-[rgba(0,240,255,0.1)]">
                  <h4 className="font-[family-name:var(--font-orbitron)] text-base text-white">
                    {item.title}
                  </h4>
    ...
    <section id="gallery" className="py-16 sm:py-24 px-4 sm:px-6">
      <div className="mx-auto max-w-6xl">
        <AnimatedSection className="text-center mb-12 sm:mb-16" variant="fade">
          ...
          <h2 className="font-[family-name:var(--font-orbitron)] text-2xl sm:text-3xl md:text-4xl font-bold text-white">
